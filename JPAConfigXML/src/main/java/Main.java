...
//    - удалить человека из базы по имени и фамилии.
        ...
        while(!input.equals("5")){
            ...
            if(input.equals("1")) {
                ...
                //List<House> houseFiltered = em.createQuery("from House where city = '"+inputCity+"'").getResultList(); - второй вариант запроса
                String queryString = "from House where city = :cityParam"; // вариант запроса через Параметры
                Query query = em.createQuery(queryString);
                query.setParameter("cityParam", inputCity);
                List<House> houseFiltered = query.getResultList();
                ...
                //int idTemp = em.createQuery("select id from House where apartment = "+oldApartment+"").getFirstResult(); - второй вариант запроса
